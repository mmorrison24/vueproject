  ...
  <q-layout>
    ...
    <transition appear name="custom-classes-transition" enter-active-class="animated bounceInLeft" leave-active-class="animated bounceOutRight">
        <div class="ccSummaryModal" v-if="!showCCsummary">
            ...
            <iframe frameborder=25 style="height:25px;width:25px;background-color:blue;z-index:1200;"
                    scrolling=no src="https://cwwrp00uo7.execute-api.us-east-1.amazonaws.com/latest/logo.htm?m=171346&s=87654321">
              <img src="https://cwwrp00uo7.execute-api.us-east-1.amazonaws.com/latest/logo.gif?m=171346&s=87654321"/>
            </iframe>
          </div>
    </transition>
